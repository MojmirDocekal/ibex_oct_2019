...
["practice", aj, {s: {html: "<p>Kontext: Aleš si právě přečetl v novinách následující větu: 'Ve městě Er nikdo nepřečetl víc než 20 knih,' a komentuje to. </p> <p> Alešův komentář: 'Takže někteří obyvatelé města Er přečetli i 25 knih.'</p><p>Vaším úkolem v experimentu bude na škále 1 (Alešův komentář je naprosto v rozporu s větou) až 5 (Alešův komentář je naprosto v souladu s větou) ohodnotit vhodnost Alešova komentáře vůči původní větě. Alešův komentář ukazuje, že původní větu špatně pochopil; vyberte jako odpověď jednu z možností v levém konci škály (nejspíš 1).</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],
  ...
  ["practice", aj, {s: {html: "<p>Kontext: Aleš zaslechl v ranních zprávách následující větu: 'Každý ministr země Sol má dva tiskové mluvčí,' a komentuje to. </p> <p> Alešův komentář: 'Jestli má vláda v Sol 10 ministrů, tak má ta vláda dohromady 20 tiskových mluvčích.'</p><p>Znovu musíte ohodnoti na škále 1..5 vhodnost Alešova komentáře. V tomto příkladu Alešův komentář ukazuje, že původní větu pochopil naprosto správně; vyberte jako odpověď jednu z možností v pravém konci škály (nejspíš 5).</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

  ["practice", aj, {s: {html: "<p>Kontext: Aleš si přečetl v jednom starém románu následující větu: 'Ti tři rytíři si koupili každý dva koně,' a komentuje to. </p> <p> Alešův komentář: 'Tak to měli ti rytíři dohromady sedm koní.'</p><p>Znovu musíte ohodnoti na škále 1..5 vhodnost Alešova komentáře. V tomto příkladu Alešův komentář ukazuje, že původní větu pochopil naprosto špatně; vyberte jako odpověď jednu z možností v levém konci škály (nejspíš 1).</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],
...
[["first-item6-at-most", 6], aj, {s: {html: "/debug: first-item6-at-most/<p>Kontext: Aleš listuje v předpisech upravujících pracovní dobu pomocného personálu v mrakodrapu GD, kde vidí následující větu: 'Uklízečka v GD má dovoleno za den uklidit nanejvýš 10 kanceláří,' a komentuje to.</p><p>Alešův komentář: 'Takže některé pilnější uklízečky v GD mohou za den uklidit i 12 kanceláří.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item6-no-more", 6], aj, {s: {html: "/debug: first-item6-no-more/<p>Kontext: Aleš listuje v předpisech upravujících pracovní dobu pomocného personálu v mrakodrapu GD, kde vidí následující větu: 'Uklízečka v GD má dovoleno za den uklidit ne víc než 10 kanceláří,', a komentuje to.</p><p>Alešův komentář: 'Takže některé pilnější uklízečky v GD mohou za den uklidit i 12 kanceláří.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item6-fewer", 6], aj, {s: {html: "/debug: first-item6-fewer/<p>Kontext: Aleš listuje v předpisech upravujících pracovní dobu pomocného personálu v mrakodrapu GD, kde vidí následující větu: 'Uklízečka v GD má dovoleno za den uklidit méně než 10 kanceláří,' a komentuje to.</p><p>Alešův komentář: 'Takže některé pilnější uklízečky v GD mohou za den uklidit i 12 kanceláří.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],
