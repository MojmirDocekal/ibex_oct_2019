...
["practice", aj, {s: {html: "<p>Kontext: Aleš si právě přečetl v novinách následující větu: 'Ve městě Er nikdo nepřečetl víc než 20 knih,' a komentuje to. </p> <p> Alešův komentář: 'Takže někteří obyvatelé města Er přečetli i 25 knih.'</p><p>Vaším úkolem v experimentu bude na škále 1 (Alešův komentář je naprosto v rozporu s větou) až 5 (Alešův komentář je naprosto v souladu s větou) ohodnotit vhodnost Alešova komentáře vůči původní větě. Alešův komentář ukazuje, že původní větu špatně pochopil; vyberte jako odpověď jednu z možností v levém konci škály (nejspíš 1).</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

  ["practice", aj, {s: {html: "<p>Kontext: Aleš zaslechl v ranních zprávách následující větu: 'Každý ministr země Sol má dva tiskové mluvčí,' a komentuje to. </p> <p> Alešův komentář: 'Jestli má vláda v Sol 10 ministrů, tak má ta vláda dohromady 20 tiskových mluvčích.'</p><p>Vaším úkolem v experimentu bude na škále 1 (Alešův komentář je naprosto v rozporu s větou) až 5 (Alešův komentář je naprosto v souladu s větou) ohodnotit vhodnost Alešova komentáře vůči původní větě. Alešův komentář ukazuje, že původní větu pochopil naprosto správně; vyberte jako odpověď jednu z možností v pravém konci škály (nejspíš 5).</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

  ["practice", aj, {s: {html: "<p>Kontext: Aleš si přečetl v jednom starém románu následující větu: 'Ti tři rytíři si koupili každý dva koně,' a komentuje to. </p> <p> Alešův komentář: 'Tak to měli ti rytíři dohromady sedm koní.'</p><p>Vaším úkolem v experimentu bude na škále 1 (Alešův komentář je naprosto v rozporu s větou) až 5 (Alešův komentář je naprosto v souladu s větou) ohodnotit vhodnost Alešova komentáře vůči původní větě. Alešův komentář ukazuje, že původní větu pochopil naprosto špatně; vyberte jako odpověď jednu z možností v levém konci škály (nejspíš 1).</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],
...
[["first-item3-at-most", 3], aj, {s: {html: "/debug: first-item3-at-most/<p>Kontext: Aleš čte místní vyhlášku upravující provoz mopedů na rychlostní silnici, vidí v ní tuto větu: 'Řidič mopedu má dovoleno jet nanejvýš 70 km/h,' a komentuje to.</p><p>Alešův komentář: 'Takže řidiči rychlejších mopedů mohou na téhle rychlostní silnici jet i 80 km/h.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item1-no-more", 3],aj, {s: {html: "/debug: first-item3-no-more/<p>Kontext: Aleš čte místní vyhlášku upravující provoz mopedů na rychlostní silnici, vidí v ní tuto větu: 'Řidič mopedu má dovoleno jet ne víc než 70 km/h,' a komentuje to.</p><p>Alešův komentář: 'Takže řidiči rychlejších mopedů mohou na téhle rychlostní silnici jet i 80 km/h.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item1-fewer", 3], aj, {s: {html: "/debug: first-item3-fewer/<p>Kontext: Aleš čte místní vyhlášku upravující provoz mopedů na rychlostní silnici, vidí v ní tuto větu: 'Řidič mopedu má dovoleno jet méně než 70 km/h,' a komentuje to.</p><p>Alešův komentář: 'Takže řidiči rychlejších mopedů mohou na téhle rychlostní silnici jet i 80 km/h.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],
...
[["first-item6-at-most", 6], aj, {s: {html: "/debug: first-item6-at-most/<p>Kontext: Aleš listuje v předpisech upravujících pracovní dobu pomocného personálu v mrakodrapu GD, kde vidí následující větu: 'Uklízečka v GD má dovoleno za den uklidit nanejvýš 10 kanceláří,' a komentuje to.</p><p>Alešův komentář: 'Takže některé uklízečky v GD mohou za den uklidit i 12 kanceláří.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item6-no-more", 6], aj, {s: {html: "/debug: first-item6-no-more/<p>Kontext: Aleš listuje v předpisech upravujících pracovní dobu pomocného personálu v mrakodrapu GD, kde vidí následující větu: 'Uklízečka v GD má dovoleno za den uklidit ne víc než 10 kanceláří,', a komentuje to.</p><p>Alešův komentář: 'Takže některé uklízečky v GD mohou za den uklidit i 12 kanceláří.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item6-fewer", 6], aj, {s: {html: "/debug: first-item6-fewer/<p>Kontext: Aleš listuje v předpisech upravujících pracovní dobu pomocného personálu v mrakodrapu GD, kde vidí následující větu: 'Uklízečka v GD má dovoleno za den uklidit méně než 10 kanceláří,' a komentuje to.</p><p>Alešův komentář: 'Takže některé uklízečky v GD mohou za den uklidit i 12 kanceláří.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],
...
[["first-item8-at-most", 8], aj, {s: {html: "/debug: first-item8-at-most/<p>Kontext: Aleš si čte instrukce týkající se jubilejního dálkového pochodu z města Er a vidí tam následující větu: 'Účastníci jubilejního dálkového pochodu mohou ujít nanejvýš 40 km,' a komentuje to.</p><p>Alešův komentář: 'Takže někteří účastníci toho pochodu mohou ujít i 50 km.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item8-no-more", 8], aj, {s: {html: "/debug: first-item8-no-more/<p>Kontext: Aleš si čte instrukce týkající se jubilejního dálkového pochodu z města Er a vidí tam následující větu: 'Účastníci jubilejního dálkového pochodu mohou ujít ne víc než 40 km,' a komentuje to.</p><p>Alešův komentář: 'Takže někteří účastníci toho pochodu mohou ujít i 50 km.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item8-fewer", 8], aj, {s: {html: "/debug: first-item8-fewer/<p>Kontext: Aleš si čte instrukce týkající se jubilejního dálkového pochodu z města Er a vidí tam následující větu: 'Účastníci jubilejního dálkového pochodu mohou ujít méně než 40 km,' a komentuje to.</p><p>Alešův komentář: 'Takže někteří účastníci toho pochodu mohou ujít i 50 km.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],
...
["filler7-good", aj, {s: {html: "/debug: filler7-good/<p>Kontext: Aleš si čte statistickou zprávu o zemi Er a v ní je následující věta: 'Každý obyvatel země Er vlastní maximálně 3 kola,' a komentuje to .</p><p>Alešův komentář: 'Takže žádný obyvatel země Er nevlastní 4 kola.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

["filler8-bad", aj, {s: {html: "/debug: filler8-bad/<p>Kontext: Aleš si čte na Wikipedii o vzdálené sluneční soustavě Solaris a vidí větu: 'V soustavě Solaris má každá planeta maximálně 3 měsíce,' a komentuje to. </p><p>Alešův komentář: 'Takže některé planety v soustavě Solaris mají 4 nebo více měsíců.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],
