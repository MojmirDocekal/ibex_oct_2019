...
[["first-item4-at-most", 4], aj, {s: {html: "/debug: first-item4-at-most/<p>Kontext: Aleš si čte vyhlášku odborů revizorů v městské hromadné dopravě, kde stojí následující věta: 'Revizor má dovoleno zkontrolovat nanejvýš 50 cestujících denně,' </b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže pilný revizor může zkontrolovat i 60 nebo víc cestujících denně.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item4-no-more", 4], aj, {s: {html: "/debug: first-item4-no-more/<p>Kontext: Aleš si čte vyhlášku odborů revizorů v městské hromadné dopravě, kde stojí následující věta: 'Revizor má dovoleno zkontrolovat ne víc než 50 cestujících denně,' </b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže pilný revizor může zkontrolovat i 60 nebo víc cestujících denně.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item4-fewer", 4], aj, {s: {html: "/debug: first-item4-fewer/<p>Kontext: Aleš si čte vyhlášku odborů revizorů v městské hromadné dopravě, kde stojí následující věta: 'Revizor má dovoleno zkontrolovat méně než 50 cestujících denně,' </b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže pilný revizor může zkontrolovat i 60 nebo víc cestujících denně.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],
...
["filler7-good", aj, {s: {html: "/debug: filler7-good/<p>Kontext: Aleš si čte statistickou zprávu o zemi Er a v ní je následující věta: 'Každý obyvatel země Er vlastní maximálně 3 kola,' </b></p><p> a komentuje to .</p><p>Alešův komentář: 'Takže žádný obyvatel země Er nevlastní 4 kola.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],
...
["filler9-good", aj, {s: {html: "/debug: filler9-good/<p>Kontext: Aleš si čte technickou zprávu o výtahu K, ve které je následující věta: 'Výtah K uveze i 5 pasažérů,' </b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže výtah K rozhodně uveze 4 pasažéry.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],
