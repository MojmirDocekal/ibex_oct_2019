...
[["first-item1-at-most", 1], aj, {s: {html: "/debug: first-item1-at-most/<p>Kontext: Aleš čte na obalu potravin následující větu: </p><p><b>Toto balení může obsahovat nanejvýš 100 gramů cukru</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže v tom jídle se občas může objevit i 110 gramů cukru.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

  [["first-item1-no-more", 1], aj, {s: {html: "/debug: first-item1-no-more/<p>Kontext: Aleš čte na obalu potravin následující větu: </p><p><b>Toto balení může obsahovat ne víc než 100 gramů cukru</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže v tom jídle se občas může objevit i 110 gramů cukru.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

  [["first-item1-fewer", 1], aj, {s: {html: "/debug: first-item1-fewer/<p>Kontext: Aleš čte na obalu potravin následující větu: </p><p><b>Toto balení může obsahovat méně než 100 gramů cukru</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže v tom jídle se občas může objevit i 110 gramů cukru.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

[["first-item2-at-most", 2], aj, {s: {html: "/debug: first-item2-at-most/<p>Kontext: Aleš čte na stojanu u benzínové pumpy následující větu: </p><p><b>Litr benzínu Ropák může obsahovat nanejvýš 0.5 gramu olova</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže v Ropákovi se občas může objevit i 0.6 gramu olova na litr.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item2-no-more", 2], aj, {s: {html: "/debug: first-item2-no-more/<p>Kontext: Aleš čte na stojanu u benzínové pumpy následující větu: </p><p><b>Litr benzínu Ropák může obsahovat ne víc než 0.5 gramu olova</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže v Ropákovi se občas může objevit i 0.6 gramu olova na litr.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item2-fewer", 2], aj, {s: {html: "/debug: first-item2-fewer/<p>Kontext: Aleš čte na stojanu u benzínové pumpy následující větu: </p><p><b>Litr benzínu Ropák může obsahovat méně než 0.5 gramu olova</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže v Ropákovi se občas může objevit i 0.6 gramu olova na litr.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

[["first-item3-at-most", 3], aj, {s: {html: "/debug: first-item3-at-most/<p>Kontext: Aleš čte místní vyhlášku upravující provoz mopedů na rychlostní silnici, vidí v ní tuto větu: </p><p><b>Řidič mopedu má dovoleno jet nanejvýš 70 km/h</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže řidiči rychlejších mopedů mohou na téhle rychlostní silnici jet i 80 km/h.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item1-no-more", 3],aj, {s: {html: "/debug: first-item3-no-more/<p>Kontext: Aleš čte místní vyhlášku upravující provoz mopedů na rychlostní silnici, vidí v ní tuto větu: </p><p><b>Řidič mopedu má dovoleno jet ne víc než 70 km/h</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže řidiči rychlejších mopedů mohou na téhle rychlostní silnici jet i 80 km/h.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item1-fewer", 3], aj, {s: {html: "/debug: first-item3-fewer/<p>Kontext: Aleš čte místní vyhlášku upravující provoz mopedů na rychlostní silnici, vidí v ní tuto větu: </p><p><b>Řidič mopedu má dovoleno jet méně než 70 km/h</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže řidiči rychlejších mopedů mohou na téhle rychlostní silnici jet i 80 km/h.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

[["first-item4-at-most", 4], aj, {s: {html: "/debug: first-item4-at-most/<p>Kontext: Aleš si čte vyhlášku odborů revizorů v městské hromadné dopravě, kde stojí následující věta:  </p><p><b>Revizor má dovoleno zkontrolovat nanejvýš 50 cestujících denně</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže pilný revizor může zkontrolovat i 60 nebo víc cestujících denně.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item4-no-more", 4], aj, {s: {html: "/debug: first-item4-no-more/<p>Kontext: Aleš si čte vyhlášku odborů revizorů v městské hromadné dopravě, kde stojí následující věta:  </p><p><b>Revizor má dovoleno zkontrolovat ne víc než 50 cestujících denně</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže pilný revizor může zkontrolovat i 60 nebo víc cestujících denně.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item4-fewer", 4], aj, {s: {html: "/debug: first-item4-fewer/<p>Kontext: Aleš si čte vyhlášku odborů revizorů v městské hromadné dopravě, kde stojí následující věta:  </p><p><b>Revizor má dovoleno zkontrolovat méně než 50 cestujících denně</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže pilný revizor může zkontrolovat i 60 nebo víc cestujících denně.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

[["first-item5-at-most", 5], aj, {s: {html: "/debug: first-item5-at-most/<p>Kontext: Aleš si čte studijní řád Miskatonické univerzity, kde vidí následující větu: </p><p><b>Bakalářská práce může mít nanejvýš 50 tisíc znaků</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže některé bakalářské práce na Miskatonické univerzitě mohou mít i 60 tisíc znaků.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item5-no-more", 5], aj, {s: {html: "/debug: first-item5-no-more/<p>Kontext: Aleš si čte studijní řád Miskatonické univerzity, kde vidí následující větu: </p><p><b>Bakalářská práce může mít ne víc než 50 tisíc znaků</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže některé bakalářské práce na Miskatonické univerzitě mohou mít i 60 tisíc znaků.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item5-fewer", 5],  aj, {s: {html: "/debug: first-item5-fewer/<p>Kontext: Aleš si čte studijní řád Miskatonické univerzity, kde vidí následující větu: </p><p><b>Bakalářská práce může mít méně než 50 tisíc znaků</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže některé bakalářské práce na Miskatonické univerzitě mohou mít i 60 tisíc znaků.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

[["first-item6-at-most", 6], aj, {s: {html: "/debug: first-item6-at-most/<p>Kontext: Aleš listuje v odborových vyhláškách pro  pomocný personál v mrakodrapu GD, kde vidí následující větu: </p><p><b>Uklízečka v GD má dovoleno za den uklidit nanejvýš 10 kanceláří</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže některé pilnější uklízečky v GD mohou za den uklidit i 12 kanceláří.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item6-no-more", 6], aj, {s: {html: "/debug: first-item6-no-more/<p>Kontext: Aleš listuje v odborových vyhláškách pro  pomocný personál v mrakodrapu GD, kde vidí následující větu: </p><p><b>Uklízečka v GD má dovoleno za den uklidit ne víc než 10 kanceláří</b></p><p>, a komentuje to.</p><p>Alešův komentář: 'Takže některé pilnější uklízečky v GD mohou za den uklidit i 12 kanceláří.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item6-fewer", 6], aj, {s: {html: "/debug: first-item6-fewer/<p>Kontext: Aleš listuje v odborových vyhláškách pro pomocný personál v mrakodrapu GD, kde vidí následující větu: </p><p><b>Uklízečka v GD má dovoleno za den uklidit méně než 10 kanceláří</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže některé pilnější uklízečky v GD mohou za den uklidit i 12 kanceláří.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

[["first-item7-at-most", 7], aj, {s: {html: "/debug: first-item7-at-most/<p>Kontext: Aleš si čte v novinách předpověď počasí na zítra a vidí tam následující větu: </p><p><b>Zítra může napršet nanejvýš 10 mm srážek</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže zítra možná naprší i 20 mm.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item7-no-more", 7], aj, {s: {html: "/debug: first-item7-no-more/<p>Kontext: Aleš si čte v novinách předpověď počasí na zítra a vidí tam následující větu: </p><p><b>Zítra může napršet ne víc než 10 mm srážek</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže zítra možná naprší i 20 mm.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

    [["first-item7-fewer", 7],  aj, {s: {html: "/debug: first-item7-fewer/<p>Kontext: Aleš si čte v novinách předpověď počasí na zítra a vidí tam následující větu: </p><p><b>Zítra může napršet méně než 10 mm srážek</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže zítra možná naprší i 20 mm.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],
...
["filler1-good", aj, {s: {html: "/debug: filler1-good/<p>Kontext: Aleš si právě přečetl v novinách následující větu: </p><p><b>Tři současní čeští básníci napsali každý právě jednu knihu básní</b></p><p> a komentuje to .</p><p>Alešův komentář: 'Takže ti tři básníci napsali tři knihy básní, co básník -- to knížka.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],
...
["filler3-good", aj, {s: {html: "/debug: filler3-good/<p>Kontext: Aleš si čte v novinách o korunovaci královny a vidí tam následující větu: </p><p><b>Ne každý státník přiletěl letadlem</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže někteří státníci dorazili na korunovaci jinak než letadlem.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],
...
["filler5-good", aj, {s: {html: "/debug: filler5-good/<p>Kontext: Aleš si právě přečetl v novinách následující větu: </p><p><b>Průměrný obyvatel města Er vlastní 2.5 kočky</b></p><p> a komentuje to .</p><p>Alešův komentář: 'Takže někteří obyvatelé v Er mají dvě kočky nebo míň, ale někteří mají tři kočky nebo víc.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

["filler6-bad", aj, {s: {html: "/debug: filler6-bad/<p>Kontext: Aleš si právě přečetl v novinách, že </p><p><b> Průměrný obyvatel města Er si vloni nepřečetl ani jednu knížku</b></p><p> a komentuje to. </p><p>Alešův komentář: 'Takže průměrný obyvatel města Er si vloni přečetl dvě a více knížek''</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

["filler7-good", aj, {s: {html: "/debug: filler7-good/<p>Kontext: Aleš si čte statistickou zprávu o zemi Er a v ní je následující věta: </p><p><b>Každý obyvatel země Er vlastní maximálně 3 kola</b></p><p> a komentuje to .</p><p>Alešův komentář: 'Takže žádný obyvatel země Er nevlastní 4 kola.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

["filler8-bad", aj, {s: {html: "/debug: filler8-bad/<p>Kontext: Aleš si čte na Wikipedii o vzdálené sluneční soustavě Solaris a vidí větu: </p><p><b>V soustavě Solaris má každá planeta maximálně 3 měsíce</b></p><p> a komentuje to. </p><p>Alešův komentář: 'Takže některé planety v soustavě Solaris mají 4 nebo více měsíců.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],

["filler9-good", aj, {s: {html: "/debug: filler9-good/<p>Kontext: Aleš si čte technickou zprávu o výtahu K, ve které je následující věta </p><p><b>Výtah K uveze i 5 pasažérů</b></p><p> a komentuje to.</p><p>Alešův komentář: 'Takže výtah K rozhodně uveze 4 pasažéry.'</p>"}, leftComment: "(Alešův komentář je naprosto v rozporu s větou)", rightComment: "(Alešův komentář je naprosto v souladu s větou)"}],
